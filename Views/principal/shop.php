        ...
        <div class="col-lg-9">
            <div class="row">
                <div class="col-md-6">
                    <ul class="list-inline shop-top-menu pb-3 pt-1">
                        ...
                        <li class="list-inline-item">
                            <a class="h3 text-dark text-decoration-none mr-3" href="#">Arroz</a>
                        </li>
                        <li class="list-inline-item">
                            <a class="h3 text-dark text-decoration-none" href="#">Aceite</a>
                        </li>
                    </ul>
                </div>
            ...
            <div div="row">
                <ul class="pagination pagination-lg justify-content-end">
                    ...
                    $url = BASE_URL . 'principal/shop/'; //url de la paginacion
                    if ($data['pagina'] > 1) {

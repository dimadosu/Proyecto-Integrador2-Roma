    ...
    <div class="container">
        <div class="row align-items-center py-5">
            <div class="col-md-8 text-white">
                <h1>Nosotros</h1>
                <p>
                    Distribuciones y Servicios Roma S.A.C. es una empresa dedicada al sector del consumo masivo que ha consolidado su presencia en las regiones de Ayacucho, Chincha e Ica, ofreciendo una amplia gama de productos y servicios para satisfacer las necesidades de sus clientes. Desde su fundación, hemos mantenido un compromiso firme con la excelencia en el servicio al cliente, la calidad de nuestros productos y la eficiencia en nuestras operaciones.
...
<section class="container py-5">
    <div class="row text-center pt-5 pb-3">
        <div class="col-lg-6 m-auto">
            ...
            <p>
                Somos líderes en el sector del consumo masivo, ofreciendo productos de
                la más alta calidad para satisfacer las necesidades de nuestros
                clientes en las región de Ica.
            </p>
        </div>
    </div>
    <div class="row">
        ...
        <div class="col-md-6 col-lg-3 pb-5">
            <div class="h-100 py-5 services-icon-wap shadow">
                ...
                <h2 class="h5 mt-4 text-center">Entrega de Productos</h2>
            </div>
        </div>
        ...
        <div class="col-md-6 col-lg-3 pb-5">
            <div class="h-100 py-5 services-icon-wap shadow">
                ...
                <h2 class="h5 mt-4 text-center">Cambios y Retornos</h2>
            </div>
        </div>
        ...
        <div class="col-md-6 col-lg-3 pb-5">
            <div class="h-100 py-5 services-icon-wap shadow">
                ...
                <h2 class="h5 mt-4 text-center">Promociones: Email</h2>
            </div>
        </div>
        ...
        <div class="col-md-6 col-lg-3 pb-5">
            <div class="h-100 py-5 services-icon-wap shadow">
                ...
                <h2 class="h5 mt-4 text-center">Atención las 24 horas</h2>
            </div>
        </div>
    </div>
</section>
